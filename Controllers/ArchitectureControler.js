...
export default class ArchitectureControler {
            ...
            const architecture = new Architecture({
                titres: {
                    ...
                    sousTitres: [
                        ...
                        { sousTitre: sousTitre3, contenuSousTitre: contenuSousTitre3, imageSecondaire3: imageSecondaire3Url }
                    ],
                },
                auteur,
                externalLink, externalLinkTitle,
    ...
    static async updateOne(req, res) {
        try {
            ...
            const updatedArchitecture = await Architecture.findByIdAndUpdate(articleId, updateData, { new: true });
